    ...
    return <Slider {...settings}>
                  ...
                  and the attention to detail is remarkable.
                   I had the time of my life rafting down wild rapids and exploring
                    hidden caves. The trip leaders were experienced and made sure everyone
                     had a fantastic experience. Can't wait to book my next adventure!"
            </p>

            <div className="d-flex align-items-center gap-4 mt-3">
                <img src={ava01} alt="" className="w-25 h-25 rounded-2" />
                <div>
                    <h6 className="mb-0 mt-3">Mark David</h6>
                    <p>Customer</p>
                </div>
            </div>
        </div>
        <div className="testimonial py-4 px-3">
            ...
            <div className="d-flex align-items-center gap-4 mt-3">
                ...
                <div>
                    <h6 className="mb-0 mt-3">Rekha Kumari</h6>
                    <p>Customer</p>
                </div>
            </div>
        </div>
        <div className="testimonial py-4 px-3">
            ...
            <div className="d-flex align-items-center gap-4 mt-3">
                ...
                <div>
                    <h6 className="mb-0 mt-3">Bodhi Krishna</h6>
                    <p>Customer</p>
                </div>
            </div>
        </div>
        <div className="testimonial py-4 px-3">
            ...
            <div className="d-flex align-items-center gap-4 mt-3">
                <img src={ava01} alt="" className="w-25 h-25 rounded-2" />
                <div>
                    <h6 className="mb-0 mt-3">Hiroshi S.</h6>
                    <p>Customer</p>
                </div>
            </div>
        </div>
              ...
              From the exhilarating trekking in the Himalayas to the
               enchanting boat ride in the backwaters of Kerala,
                every experience was a true delight. The guides were
                 friendly and shared fascinating stories about the places
                  we visited. Shukriya for an unforgettable Asian-style adventure!"
            </p>

            <div className="d-flex align-items-center gap-4 mt-3">
                <img src={ava02} alt="" className="w-25 h-25 rounded-2" />
                <div>
                    <h6 className="mb-0 mt-3">Ananya Kumari</h6>
                    <p>Customer</p>
                </div>
            </div>
        </div>
